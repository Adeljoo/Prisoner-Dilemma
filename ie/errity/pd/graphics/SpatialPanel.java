...
public class SpatialPanel extends JPanel implements ActionListener
{
	...
	//private JLabel ConfidenceP1, ConfidenceP2;
	...
	public SpatialPanel(MenuFrame mf)
	{
		...
		//Confidence = new Rules(mf,"Confidence");
		...
		if(stopped == true)
		{
	    	...
	    	worker = new SwingWorker() 
			{
				public Object construct()
		        {
					...
					double Confidence = rules.getConfidence();
					...
					*/
					...
					{	
					    ...
					    Confidence= grid.getConfidences();
						min = scores[0][0];
						max = scores[0][0];
						minIndexA = 0;
						minIndexB = 0;
