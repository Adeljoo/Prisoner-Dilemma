...
public class Prisoner implements Cloneable
{
	...
	/**
	 *Adds value to the Prisoner's current turst
	 *@param Confidence the value to be added
	 *@return the new Confidence
	 */
	public double updateConfidence(double ConfidenceP1)
	{
		Confidence = ConfidenceP1 + Confidence;
		return Confidence;
	}
	
	/**
	 *Returns the Prisoner's current Confidence
	 *@return the Prisoner's current Confidence
	 */
	public double getConfidence(){return Confidence;} 
	
	/**
	 *Set the Prisoner's current Confidence
	 *@param Confidence the new Confidence
	 */
	public void setConfidence(double ConfidenceP1)
	{
		Confidence = ConfidenceP1;
	}
	...
	/**
	 * Claculate the Confidence level here. 
	 * if they both cooperate then Confidence increase * 10% 
	 * if they both defect then Confidence decrease - 10% 
	 * A cooperate and b defect then Confidence in B decrease by 10% 
	 * A defect and B cooperate Confidence in A decrease by 1%  
	 */ 
