...
public class Spatial extends JPanel
{
	...
	private double[]Confidence; // Record result of Confidence 
	...
	public void Mate()
	{
		...
		//Confidence
				Offspring[0] = Genetic.Confidence(Offspring[0], rules.getConfidence());
				Offspring[1] = Genetic.Confidence(Offspring[1], rules.getConfidence());
